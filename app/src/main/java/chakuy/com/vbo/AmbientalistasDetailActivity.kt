...
class AmbientalistasDetailActivity : AppCompatActivity(), OnMapReadyCallback {

    private lateinit var currentUnit: AmbientalistasUnit // <--- TIPO CORRECTO
    private lateinit var googleMap: GoogleMap

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ambientalista_detail) // <--- LAYOUT CORRECTO

        // Recibir datos
        currentUnit = intent.getSerializableExtra("UNIT_DATA") as? AmbientalistasUnit ?: AmbientalistasUnit()

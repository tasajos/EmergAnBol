...
class AnimalistaDetailActivity : AppCompatActivity(), OnMapReadyCallback {

    private lateinit var currentUnit: AnimalistaUnit // <--- TIPO CORRECTO
    private lateinit var googleMap: GoogleMap

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_animalista_detail) // <--- LAYOUT CORRECTO

        // Recibir datos
        currentUnit = intent.getSerializableExtra("UNIT_DATA") as? AnimalistaUnit ?: AnimalistaUnit()
    ...
    // (Son las mismas que en los otros activities)

...
class AnimalistasListActivity : AppCompatActivity() {

    private lateinit var dbRef: DatabaseReference
    private lateinit var recyclerView: RecyclerView
    private lateinit var progressBar: ProgressBar
    private lateinit var listaCompleta: ArrayList<AnimalistaUnit>
    private lateinit var adapter: AnimalistaAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_animalistas_list) // <--- Layout correcto
        ...
        adapter = AnimalistaAdapter(arrayListOf())
    ...
    private fun getData() {
        // REFERENCIA A FIREBASE: /animalistas
        dbRef = FirebaseDatabase.getInstance().getReference("animalistas")
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()) {
                    for (ds in snapshot.children) {
                        val unit = ds.getValue(AnimalistaUnit::class.java)
    ...
    private fun setupBuscador() {
        ...
        etBuscador.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                val filtrada = ArrayList<AnimalistaUnit>()
    ...
    // --- Navegación (Copia y pega las funciones setupBottomNavigation y handleNavigationClick de tus otros activities) ---

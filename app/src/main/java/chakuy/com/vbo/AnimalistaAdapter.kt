...
class AnimalistaAdapter(private var lista: ArrayList<AnimalistaUnit>) :
    RecyclerView.Adapter<AnimalistaAdapter.ViewHolder>() {

    fun actualizarLista(nuevaLista: ArrayList<AnimalistaUnit>) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        // Reutilizamos el diseño de item_bombero_unit (es el mismo estilo)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(holder.itemView.context, AnimalistaDetailActivity::class.java)

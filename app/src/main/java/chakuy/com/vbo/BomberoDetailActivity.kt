...
class BomberoDetailActivity : AppCompatActivity(), OnMapReadyCallback {

    private lateinit var currentUnit: BomberoUnit
    private lateinit var googleMap: GoogleMap

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_bombero_detail)

        // 1. Recibir el Objeto Serializable
        currentUnit = intent.getSerializableExtra("UNIT_DATA") as? BomberoUnit ?: BomberoUnit()

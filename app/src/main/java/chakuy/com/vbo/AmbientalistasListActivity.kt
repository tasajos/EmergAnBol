...
class AmbientalistasListActivity : AppCompatActivity() {

    private lateinit var dbRef: DatabaseReference
    private lateinit var recyclerView: RecyclerView
    private lateinit var progressBar: ProgressBar
    private lateinit var listaCompleta: ArrayList<AmbientalistasUnit>
    private lateinit var adapter: AmbientalistasAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ambientalistas_list) // <--- Layout correcto
        ...
        adapter = AmbientalistasAdapter(arrayListOf())
    ...
    private fun getData() {
        // REFERENCIA A FIREBASE: /ambientalistas
        dbRef = FirebaseDatabase.getInstance().getReference("ambientalistas")
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()) {
                    for (ds in snapshot.children) {
                        val unit = ds.getValue(AmbientalistasUnit::class.java)
    ...
    private fun setupBuscador() {
        ...
        etBuscador.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                val filtrada = ArrayList<AmbientalistasUnit>()

...
import androidx.recyclerview.widget.LinearLayoutManager // CAMBIO AQUÍ
import androidx.recyclerview.widget.RecyclerView
import com.google.firebase.database.*

class HospitalesListActivity : AppCompatActivity() {

    private lateinit var dbRef: DatabaseReference
    private lateinit var recyclerView: RecyclerView
    private lateinit var progressBar: ProgressBar
    private lateinit var listaCompleta: ArrayList<HospitalUnit>
    private lateinit var adapter: HospitalAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_hospitales_list)

        progressBar = findViewById(R.id.progressBar)
        progressBar.visibility = View.VISIBLE

        recyclerView = findViewById(R.id.recyclerHospitales)
        recyclerView.layoutManager = LinearLayoutManager(this) // CAMBIO AQUÍ: Lista vertical
        recyclerView.setHasFixedSize(true)

        listaCompleta = arrayListOf()
        adapter = HospitalAdapter(arrayListOf())
    ...
    private fun getData() {
        // REFERENCIA A FIREBASE: /hospitales
        dbRef = FirebaseDatabase.getInstance().getReference("hospitales")
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()) {
                    for (ds in snapshot.children) {
                        val unit = ds.getValue(HospitalUnit::class.java)
    ...
    private fun setupBuscador() {
        ...
        etBuscador.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                val filtrada = ArrayList<HospitalUnit>()
    ...
    // --- COPIA Y PEGA LAS FUNCIONES DE NAVEGACIÓN ESTÁNDAR ---

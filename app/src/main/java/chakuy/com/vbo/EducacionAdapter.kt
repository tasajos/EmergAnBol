...
class EducacionAdapter(private var lista: ArrayList<EducacionUnit>) :
    RecyclerView.Adapter<EducacionAdapter.ViewHolder>() {

    fun actualizarLista(nuevaLista: ArrayList<EducacionUnit>) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(holder.itemView.context, EducacionDetailActivity::class.java)
